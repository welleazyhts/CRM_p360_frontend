...
const RenewalFailedCases = () => {
  ...
  const [editFormData, setEditFormData] = useState({ priority: '', status: '', failureReason: '' });
  ...
  const handleSaveEdit = () => {
    ...
    const updatedCases = cases.map(c =>
      c.id === actionCase.id ? {
        ...
        failureReason: editFormData.failureReason,
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, pt: 1 }}>
            ...
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="Renewal Failed">Renewal Failed</MenuItem>
                <MenuItem value="Retry Payment">Retry Payment</MenuItem>
            ...
            <TextField
              ...
              onChange={(e) => setEditFormData({ ...editFormData, failureReason: e.target.value })}
              fullWidth
            />
          </Box>
        </DialogContent>
